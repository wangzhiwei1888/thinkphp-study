...
<div class="s_center container col-lg-6 ">
    ...
    <div class="form-signin" enctype="multipart/form-data">
      ...
      <br />
      <button class="btn btn-lg btn-primary btn-block" onclick="login.check()" >登录</button>
    </div>
...
<script src="/demo/Public/js/admin/login.js"></script>
