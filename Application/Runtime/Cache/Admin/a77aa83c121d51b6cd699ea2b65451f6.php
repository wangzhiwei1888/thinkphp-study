                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="radio" name="type" id="optionsRadiosInline2" <?php if($menu["type"] == 0): ?>checked<?php endif; ?> value="0"> 前端栏目
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="radio" name="status" id="optionsRadiosInline2" <?php if($menu["status"] == 0): ?>checked<?php endif; ?> value="0"> 关闭
                        </div>
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/demo/admin.php?c=menu&a=add',
