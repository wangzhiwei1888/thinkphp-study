        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" value="<?php echo ($news["title"]); ?>" name="title" class="form-control" id="inputname" placeholder="请填写标题">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">短标题:</label>
              <div class="col-sm-5">
                <input type="text" name="small_title" class="form-control" id="inputname" value="<?php echo ($news["small_title"]); ?>" placeholder="请填写短标题">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                ...
                <img style="display: block;" id="upload_org_code_img" src="<?php echo ($news["thumb"]); ?>" width="150" height="150">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                    <?php if(is_array($copyFrom)): foreach($copyFrom as $key=>$item): ?><option value="<?php echo ($key); ?>" <?php if($key == $news['copyfrom']): ?>selected="selected"<?php endif; ?> ><?php echo ($item); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
...
<script>
  var SCOPE = {
    ...
    'ajax_upload_image_url' : '/demo/admin.php?c=image&a=ajaxuploadimage',
    'ajax_upload_swf' : '/demo/Public/js/party/uploadify.swf',
  };
...
<script>
  ...
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/demo/admin.php?c=image&a=kindupload',
