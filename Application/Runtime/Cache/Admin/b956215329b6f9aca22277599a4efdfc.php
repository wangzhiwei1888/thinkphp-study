    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/demo/admin.php?c=menu">菜单管理</a>
                    </li>
                    <li class="active">
        ...
        <!-- /.row -->
        <div class="row">
            <form action="/demo/admin.php" method="get">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><span class="glyphicon glyphicon-edit singcms-edit" aria-hidden="true" attr-id="<?php echo ($menu["menu_id"]); ?>"></span>    <a href="javascript:void(0)" attr-id="<?php echo ($menu["menu_id"]); ?>" class="singcms-delete"  attr-a="menu" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>
                    ...
                    <div>
                      <button  id="button-listorder" type="button" class="btn btn-primary dropdown-toggle" ><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>排序 </button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    var SCOPE = {
        'add_url' : '/demo/admin.php?c=menu&a=add',
        'edit_url' : '/demo/admin.php?c=menu&a=edit',
        'set_status_url' : '/demo/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/demo/admin.php?c=menu&a=listorder',
